...
<head>
    ...
    <title>Product Categories List</title>
...
<body>
	                    ...
	                    <div class="ibox-title">
	                    	 <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
								<a class="navbar-minimalize minimalize-styl-2 btn btn-primary "
									...
									<h4 class="p-h-sm font-normal"> Product Categories Informaiton</h4>
							</nav>
	                    </div>
	                    <div class="ibox-content">
	                        <div id="productCategoryGrid" style="margin-top:8px"></div>
	                    </div>
	                </div>
	            </div>
        	</div>
    ...
    <form id="form1" name="form1" method="post" action="createProductCategory.php">
	 ...
	 isSelectAll = false;
        ...
        function loadGrid(){
            ...
            var source =
            {
                ...
                url: 'Actions/ProductCategoryAction.php?call=getAllProductCategories',
                root: 'Rows',
                cache: false,
                ...
                filter: function()
                {
                    ...
                    $("#productCategoryGrid").jqxGrid('updatebounddata', 'filter');
                },
                sort: function()
                {
                    // update the grid and send a request to the server.
                    $("#productCategoryGrid").jqxGrid('updatebounddata', 'sort');
                }
            };
            
            var dataAdapter = new $.jqx.dataAdapter(source);
            // initialize jqxGrid
            $("#productCategoryGrid").jqxGrid(
            {
            	width: '100%',
    			height: '75%',
    			source: dataAdapter,
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    addButton.click(function (event) {
                        location.href = ("createProductCategory.php");
                    });
                    // update row.
                    editButton.click(function (event){
                    	var selectedrowindex = $("#productCategoryGrid").jqxGrid('selectedrowindexes');
                        var value = -1;
                        ...
                        var row = $('#productCategoryGrid').jqxGrid('getrowdata', indexes);
                        $("#seq").val(row.seq);                        
                        $("#form1").submit();    
                    });
                    // delete row.
                    deleteButton.click(function (event) {
                        gridId = "productCategoryGrid";
                        deleteUrl = "Actions/ProductCategoryAction.php?call=deleteProductCategories";
                        deleteItems(gridId,deleteUrl);
                    });
                    reloadButton.click(function (event) {
                    	$("#productCategoryGrid").jqxGrid({ source: dataAdapter });
                    });
                }
            });
        }
