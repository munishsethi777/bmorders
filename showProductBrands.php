...
<head>
    ...
    <title>Product Brands List</title>
...
<body>
	                    ...
	                    <div class="ibox-title">
	                    	 <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
								<a class="navbar-minimalize minimalize-styl-2 btn btn-primary "
									...
									<h4 class="p-h-sm font-normal"> Product Brands Informaiton</h4>
							</nav>
	                    </div>
	                    <div class="ibox-content">
	                        <div id="productBrandGrid" style="margin-top:8px"></div>
	                    </div>
	                </div>
	            </div>
        	</div>
    ...
    <form id="form1" name="form1" method="post" action="createProductBrand.php">
	 ...
	 isSelectAll = false;
        ...
        function loadGrid(){
            ...
            var source =
            {
                ...
                url: 'Actions/ProductBrandAction.php?call=getAllProductBrands',
                root: 'Rows',
                cache: false,
                ...
                filter: function()
                {
                    ...
                    $("#productBrandGrid").jqxGrid('updatebounddata', 'filter');
                },
                sort: function()
                {
                    // update the grid and send a request to the server.
                    $("#productBrandGrid").jqxGrid('updatebounddata', 'sort');
                }
            };
            
            var dataAdapter = new $.jqx.dataAdapter(source);
            // initialize jqxGrid
            $("#productBrandGrid").jqxGrid(
            {
            	width: '100%',
    			height: '75%',
    			source: dataAdapter,
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    addButton.click(function (event) {
                        location.href = ("createProductBrand.php");
                    });
                    // update row.
                    editButton.click(function (event){
                    	var selectedrowindex = $("#productBrandGrid").jqxGrid('selectedrowindexes');
                        var value = -1;
                        ...
                        var row = $('#productBrandGrid').jqxGrid('getrowdata', indexes);
                        $("#seq").val(row.seq);                        
                        $("#form1").submit();    
                    });
                    // delete row.
                    deleteButton.click(function (event) {
                        gridId = "productBrandGrid";
                        deleteUrl = "Actions/ProductBrandAction.php?call=deleteProductBrands";
                        deleteItems(gridId,deleteUrl);
                    });
                    reloadButton.click(function (event) {
                    	$("#productBrandGrid").jqxGrid({ source: dataAdapter });
                    });
                }
            });
        }
