	 ...
	 isSelectAll = false;
        ...
        function loadGrid(userTypes){
         	var columns = [
				...
				{ text: 'Created On', datafield: 'createdon',width:"17%",filtertype: 'range' ,cellsformat: 'd-M-yyyy hh:mm tt'},
				{ text: 'Last Modified', datafield: 'lastmodifiedon',width:"17%",filtertype: 'range' ,cellsformat: 'd-M-yyyy hh:mm tt'}
            ]
