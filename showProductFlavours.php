...
<head>
    ...
    <title>Product Flavours List</title>
...
<body>
	                    ...
	                    <div class="ibox-title">
	                    	 <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
								<a class="navbar-minimalize minimalize-styl-2 btn btn-primary "
									...
									<h4 class="p-h-sm font-normal"> Product Flavours Informaiton</h4>
							</nav>
	                    </div>
	                    <div class="ibox-content">
	                        <div id="productFlavourGrid" style="margin-top:8px"></div>
	                    </div>
	                </div>
	            </div>
        	</div>
    ...
    <form id="form1" name="form1" method="post" action="createProductFlavour.php">
	...
	<script type="text/javascript">
	 isSelectAll = false;
        ...
        function deleteItems(gridId,deleteURL){
        ...
        function loadGrid(){
            ...
            var source =
            {
                ...
                url: 'Actions/ProductFlavourAction.php?call=getAllProductFlavours',
                root: 'Rows',
                cache: false,
                ...
                filter: function()
                {
                    ...
                    $("#productFlavourGrid").jqxGrid('updatebounddata', 'filter');
                },
                sort: function()
                {
                    // update the grid and send a request to the server.
                    $("#productFlavourGrid").jqxGrid('updatebounddata', 'sort');
                }
            };
            
            var dataAdapter = new $.jqx.dataAdapter(source);
            // initialize jqxGrid
            $("#productFlavourGrid").jqxGrid(
            {
            	width: '100%',
    			height: '75%',
    			source: dataAdapter,
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    addButton.click(function (event) {
                        location.href = ("createProductFlavour.php");
                    });
                    // update row.
                    editButton.click(function (event){
                    	var selectedrowindex = $("#productFlavourGrid").jqxGrid('selectedrowindexes');
                        var value = -1;
                        ...
                        var row = $('#productFlavourGrid').jqxGrid('getrowdata', indexes);
                        $("#seq").val(row.seq);                        
                        $("#form1").submit();    
                    });
                    // delete row.
                    deleteButton.click(function (event) {
                        gridId = "productFlavourGrid";
                        deleteUrl = "Actions/ProductFlavourAction.php?call=deleteProductFlavours";
                        deleteItems(gridId,deleteUrl);
                    });
                    reloadButton.click(function (event) {
                    	$("#productFlavourGrid").jqxGrid({ source: dataAdapter });
                    });
                }
            });
        }
